    ...
    setupGrid: function (grid, pager, search, direction) {
        ...
        grid.jqGrid({
            ...
            colModel: [ //http://php.net/manual/en/function.date.php
                        ...
                        {name: 'check_1_dt', index: 'check_1_dt', align: 'center', width: '90px', sortable: true, hidden: false, resizable: false, sorttype: 'date', formatter: 'date', formatoptions: { srcformat: 'Y m d', newformat: 'd-M-Y'} },
                        ...
                        {name: 'check_2_dt', index: 'check_2_dt', align: 'center', width: '90px', sortable: true, hidden: false, resizable: false, sorttype: 'date', formatter: 'date', formatoptions: { srcformat: 'Y m d', newformat: 'd-M-Y'} },
                        ...
                        {name: 'check_3_dt', index: 'check_3_dt', align: 'center', width: '90px', sortable: true, hidden: false, resizable: false, sorttype: 'date', formatter: 'date', formatoptions: { srcformat: 'Y m d', newformat: 'd-M-Y'} },
